...
import { Home, User, FileText, Building2, Settings, Briefcase, Heart, LogOut } from "lucide-react"
...
export function AppSidebar({ Role = "candidat", className, user, session, onLogout, ...props }: AppSidebarProps) {
